...
class MainScaffold extends StatefulWidget {
  ...
  int currentIndex = 0;
  MainScaffold(
      {@required this.shopList, @required this.cart, @required this.ongoing});
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(
              icon: Icon(Icons.fastfood), title: Text("Buy")),
          BottomNavigationBarItem(
              icon: Icon(Icons.timer), title: Text("On-going")),
          BottomNavigationBarItem(
